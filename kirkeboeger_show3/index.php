...
<title>Vis arkivalie, den jeg vil bruge</title>
...
<img src="Praest_der_laeser.png" style="width:304px;height:228px;padding-left:10px;">
  <hr>
...
function minusTen() {
 ...
 <!-- Input field for page search -->
  <div class="flex-item"><input type="text" style="width: 45px; text-align:right; color: #f6f6f6; background-color:#666666; border:none; margin-right:0px; margin-left:5px";id="my_text-input" value="Side"></div>
